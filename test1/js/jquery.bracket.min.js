...
!function (t) {
    ...
    var T = function () {
        ...
        return Object.defineProperty(e.prototype, "el", {
            ...
            var i = this, o = this.matches.length, h = null !== t ? t() : [{
                    source: function () {
        ...
        return Object.defineProperty(t.prototype, "el", {
            ...
            var e = this.rounds.length, o = e > 0 ? n.of(this.rounds[e - 1]) : n.empty(),
    ...
    var N = function () {
        ...
        return Object.defineProperty(e.prototype, "el", {
            ...
            var n = this, r = "lr" === this.opts.dir ? "right" : "left", i = this.teamCon.height() / 4,
                o = this.matchCon.height() / 2, s = e.map(function (t) {
                    ...
                    return n.seed % 2 == 0 ? n.winner().order.map(function (t) {
                        ...
                        return t.map({
                            height: -o + i * (n.opts.centerConnectors ? 0 : 2),
                            shift: -i * (n.opts.centerConnectors ? 2 : 3)
                        }, {height: -o, shift: -i * (n.opts.centerConnectors ? 2 : 1)})
                    }).orElse({height: -o + i * (n.opts.centerConnectors ? 0 : 1), shift: 2 * -i})
                });
            this.teamCon.append(function (e, n, r, i) {
                var o = n.shift, s = R(n.height), a = s.height, h = s.drop, c = e / 2,
        ...
        var r = new O, i = e.init, o = i.results.length <= 1, s = 45 * i.teams.length + i.teams.length * e.matchMargin,
        ...
        return c = new M(m, n.of(i.results[0] || null), T, !0, e), o || (u = new M(v, n.of(i.results[1] || null), T, !1, e), e.skipGrandFinalComeback || (l = new M(f, n.of(i.results[2] || null), T, !1, e))), function (t, e, r, i, o) {
            ...
            for (var s = Math.log(2 * r) / Math.log(2) - 1, a = r / 2, h = 0; h < s; h += 1) {
                for (var c = i && h === s - 1 ? 1 : 2, u = 0; u < c; u += 1) for (var l = e.addRound(n.empty()), p = 0; p < a; p += 1) {
                    var d = u % 2 != 0 || 0 === h ? E(t, e, a, p, u, h) : null, f = h === s - 1 && i,
                        m = l.addMatch(d, n.of(f ? b : null));
                    if (m.setAlignCb(w(m.el.find(".teamContainer"), m)), f) m.setConnectorCb(n.empty()); else if (h < s - 1 || u < 1) {
            ...
            var a = t.addRound(n.empty()), h = a.addMatch(function () {
                ...
                if (i.skipSecondaryFinal || o.winner().name.isEmpty() || o.winner().name !== r.winner().name) {
                    if (2 === t.size()) t.dropRound(); else if (t.size() > 2) throw new Error("Unexpected number of final rounds");
                    return g(o)
                }
            ...
            e.final().setConnectorCb(n.of(function (t) {
                var n = t.height() / 4,
                    ...
                    s = e.winner().order.map(function (t) {
                        ...
                        }, {height: o + n * (i.centerConnectors ? 2 : 0), shift: n * (i.centerConnectors ? 2 : 3)})
                ...
                var n = t.height() / 4,
                    ...
                    s = r.winner().order.map(function (t) {
                        ...
                        }, {height: o + 2 * n, shift: n * (i.centerConnectors ? 2 : 1)})
                    }).orElse({height: o + n * (i.centerConnectors ? 2 : 1), shift: 2 * n}), a = s.height, h = s.shift;
                return {height: -(a + t.height() / 2), shift: -h}
            }))
        }(l, c, u, e, 0, h)), p(!1), {
    ...
    var F = function (t, e) {
        ...
        init: function (e) {
            ...
            o.decorator || (o.decorator = {edit: f, render: m}), o.init || (o.init = {
                results: [],
